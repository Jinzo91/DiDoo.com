            ...
            <div style={{
                ...
                <TableRow style={{
                    ...
                    <TableColumn style={{marginLeft: '50px', marginTop: '100px', width: '10%'}}><SimpleLink
                        style={{fontWeight: 'bold', fontSize: '20px', fontFamily: 'San Francisco',}}
                    ...
                    <TableColumn style={{
                        ...
                        textAlign: 'center',
                        width: '10%'
                    }}>{(new Date(this.props.cart.ticket.date)).toLocaleString("en-GB").slice(0, 10)}</TableColumn>
                    <TableColumn style={{
                        fontWeight: 'bold',
                        marginLeft: '50px',
                        fontSize: '20px',
                        ...
                        textAlign: 'center',
                        width: '10%'
                    }}>Quantity: {this.state.quantity}</TableColumn>
                    <TableColumn style={{marginLeft: 'auto', marginTop: '100px', textAlign: 'center', width: '10%'}}>
                        <Button style={{marginLeft: '-10px', marginTop: '-8px'}} icon
                                onClick={this.incrementQuantity}>add_circle</Button>
                        <Button style={{marginLeft: '-10px', marginTop: '-8px'}} icon disabled={this.state.quantity < 2}
                                onClick={this.decrementQuantity}>remove_circle</Button>
                    </TableColumn>
                    {UserService.isAuthenticated() ?
                        <TableColumn style={{marginLeft: '0px', marginTop: '100px', width: '30px'}}><Button
                            style={{marginTop: '-8px'}} onClick={() => this.props.onDelete(this.props.cart._id)}
                    ...
                    <TableColumn style={{
                        ...
                        textAlign: 'center',
                        width: '10%'
                    }}>Price: {(this.state.quantity) * (this.props.cart.attraction.price)} ¥</TableColumn>

        ...
        return (
            <Card style={style}
                ...
                <CardActions expander>
                    <Button style={{marginLeft: '15px', marginRight: '20px', marginBottom: '5px', color: 'white'}}
                            raised primary><Link style={{textDecoration: 'none', color: 'white'}}
                                                 to={`/edit/${this.props._id}`}>Edit</Link></Button>

                    <Button style={{marginRight: '50px', marginBottom: '5px', color: 'white'}} raised primary
                            onClick={this.show}>delete</Button>
                    ...
                    <DialogContainer
                        ...
                        actions={<Button style={{marginLeft: '25px', marginBottom: '10px', color: 'white'}} raised
                                         primary
                                         onClick={() => this.props.onDelete(this.props._id) && this.hide}>delete</Button>}

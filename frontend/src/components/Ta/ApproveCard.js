        ...
        return (
            ...
            <Card style={style}
                ...
                <CardActions expander>
                    <Button style={{marginLeft:'25px',marginBottom:'10px',color:'white'}} raised primary onClick={this.show} >Approve</Button>

                    <DialogContainer
                        id="simple-action-dialog"
                        visible={visible}
                        onHide={this.hide}
                        actions={ <Button style={{marginLeft:'25px',marginBottom:'10px',color:'white'}} raised primary onClick={() => this.props.onApprove(this.props._id)&& this.hide}>Approve</Button>}
